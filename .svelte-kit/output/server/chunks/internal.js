import { A as set, B as set_hydrating, C as component_root, D as get_next_sibling, E as get_first_child, F as push, G as hydration_failed, I as async_mode_flag, J as array_from, K as LEGACY_PROPS, L as hydrate_node, M as flushSync, N as component_context, O as init_operations, P as pop, R as hydrating, S as set_active_reaction, T as create_text, V as hydration_mismatch, W as HYDRATION_ERROR, Y as define_property, b as get, c as render, d as setContext, h as is_passive_event, j as boundary, k as mutable_source, o as derived, v as active_effect, w as clear_text_content, x as set_active_effect, y as active_reaction, z as set_hydrate_node } from "./index-server.js";
/**
...
//#endregion
//#region node_modules/@sveltejs/kit/src/runtime/app/environment/index.js
var browser = false;
//#endregion
...
function Root($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		if (!browser) setContext("__svelte__", stores);
		if (browser) {} else stores.page.set(page);
...
var options = {
	...
	templates: {
		app: ({ head, body, assets, nonce, env }) => "<!doctype html>\n<html lang=\"en\">\n  <head>\n    <meta charset=\"UTF-8\" />\n    <link rel=\"icon\" href=\"data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><text y=%22.9em%22 font-size=%2290%22>🐱</text></svg>\" />\n    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\" />\n    <meta name=\"description\" content=\"Track your cat's expenses with purr-fection. A beautiful, client-only expense tracker for cat owners.\" />\n    <meta name=\"theme-color\" content=\"#0f0f1a\" />\n    <title>Cat Expense — Track Your Feline's Spending</title>\n    " + head + "\n  </head>\n  <body>\n    <div style=\"display: contents\">" + body + "</div>\n  </body>\n</html>\n",
		error: ({ status, message }) => "<!doctype html>\n<html lang=\"en\">\n	<head>\n		<meta charset=\"utf-8\" />\n		<title>" + message + "</title>\n\n		<style>\n			body {\n				--bg: white;\n				--fg: #222;\n				--divider: #ccc;\n				background: var(--bg);\n				color: var(--fg);\n				font-family:\n					system-ui,\n					-apple-system,\n					BlinkMacSystemFont,\n					'Segoe UI',\n					Roboto,\n					Oxygen,\n					Ubuntu,\n					Cantarell,\n					'Open Sans',\n					'Helvetica Neue',\n					sans-serif;\n				display: flex;\n				align-items: center;\n				justify-content: center;\n				height: 100vh;\n				margin: 0;\n			}\n\n			.error {\n				display: flex;\n				align-items: center;\n				max-width: 32rem;\n				margin: 0 1rem;\n			}\n\n			.status {\n				font-weight: 200;\n				font-size: 3rem;\n				line-height: 1;\n				position: relative;\n				top: -0.05rem;\n			}\n\n			.message {\n				border-left: 1px solid var(--divider);\n				padding: 0 0 0 1rem;\n				margin: 0 0 0 1rem;\n				min-height: 2.5rem;\n				display: flex;\n				align-items: center;\n			}\n\n			.message h1 {\n				font-weight: 400;\n				font-size: 1em;\n				margin: 0;\n			}\n\n			@media (prefers-color-scheme: dark) {\n				body {\n					--bg: #222;\n					--fg: #ddd;\n					--divider: #666;\n				}\n			}\n		</style>\n	</head>\n	<body>\n		<div class=\"error\">\n			<span class=\"status\">" + status + "</span>\n			<div class=\"message\">\n				<h1>" + message + "</h1>\n			</div>\n		</div>\n	</body>\n</html>\n"
	},
	version_hash: "13h0r2x"
};
...
//#endregion
export { set_read_implementation as a, set_private_env as c, set_manifest as i, set_public_env as l, options as n, public_env as o, read_implementation as r, safe_public_env as s, get_hooks as t, set_safe_public_env as u };
